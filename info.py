...
BOT_TOKEN = environ.get('BOT_TOKEN', '7543898375:AAFcmqREiZiwR1WGr16j6qXDW8e1kvJSWiY')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5677530416 7871556756').split()]
USERNAME = environ.get('USERNAME', "https://t.me/Rohit1211p") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002056677294'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/movieboxbot1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002066309708').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://madarazbotz:RFUcRzGGzwna8Fzj@cluster0.70pvm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', 'https://t.me/moviesvisit'))
request_channel = environ.get('REQUEST_CHANNEL', 'https://t.me/movieboxbot1') # If anyone sends a request message to your bot, you will get it in this channel.
...
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/moviesvisit")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "3097623f852197a9ce40d1212aaa8bbf2803e799")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'Schlr.online')
SHORTENER_API2 = environ.get("SHORTENER_API2", "87c34d28732c7ee001e815ef914eef75d55f1614")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/f703f2255bc7b634631e2-60a8bdce8d1edd02c9.png')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://graph.org/file/7eb510dd457148fa932c5-f470e64a3e9a0919b7.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/f703f2255bc7b634631e2-60a8bdce8d1edd02c9.png'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
